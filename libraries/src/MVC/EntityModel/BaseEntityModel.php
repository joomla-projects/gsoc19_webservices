...
abstract class BaseEntityModel extends EntityModel
{
	 ...
	 * @var    \JObject
	 * @since  3.0
	 * @todo how do we deal with this? Can we populate it on model instantiation?
	 */
	protected $state;
	...
	{
		$checkedOutField = $item->getColumnAlias('checked_out');

		if ($item->hasField($checkedOutField) && $item->{$checkedOutField} != \JFactory::getUser()->id)
		{
			return true;
		}
